  ...
  useGSAP(() => {
    ...
    return (
       <nav className="flex max-w-3xl  items-center m-0 m-auto">
            ...
            <ul className="flex gap-2 items-center text-gray-700 font-medium underline cursor-pointer text-sm ml-auto">
